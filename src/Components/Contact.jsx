...
function Contact() {
  ...
  const direction = localStorage.getItem("i18nextLng") === "ar" ? "rtl" : "ltr";

  return (
    <div id="contact" className={`flex flex-col justify-center items-center pt-[vh] ${direction === 'rtl' ? 'text-right' : 'text-left'}`}>
      ...
      <div className="flex flex-col 2xl:flex-row w-full max-w-4xl gap-8">
        ...
        <div className="flex-1 p-6 rblackg text-2xl">
          ...
          <div className="border border-black p-2 my-4">
            <a href="https://wa.me/966571348034?text=Hello%2C%20I%20would%20like%20to%20enquire%20about%20spare%20parts" className='flex'>
              <FaWhatsapp className='mr-3' />{t('contact.wa')}
            </a>
          </div>
          <div className="border border-black p-2 my-4">
            <a href="mailto:sales@fleetsfix.com?subject=I%20would%20like%20to%20enquire%20about%20spare%20parts&body=Hello%2C%20I%20would%20like%20to%20know%20more%20about%20your%20spare%20parts." className='flex'>
              <CiMail className='mr-3' />{t('contact.ma')}
            </a>
          </div>
          <div className="border border-black p-2">
            <a href="tel:+966571348034" className='flex'>
              <PhoneCall className='mr-3' />{t('contact.ph')}
            </a>
          </div>
